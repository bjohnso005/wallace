...
*Wallace* (v2024.06.21) currently includes thirteen components, or steps of a possible workflow. Each component includes two or more modules, which are possible analyses for that step.  
...
**10.** *Mask Prediction*  
- Upload User Prediction  
- Mask by Shapefile  
- Mask by Drawn Polygon  
- Temporal Extract  

**11.** *Calculate Indicators*  
- Calculate Area Metrics  
- Calculate Ratio Overlap  
